  ...
  {currentContent}
      ...
      <DemoSection>
        ...
        <DemoRow>
          ...
          <ContentDisplay>
            <div className='content-text'>{dynamicTabs[dynamicTabIndex]?.content || '内容未找到'}</div>
          </ContentDisplay>
        </DemoRow>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              ...
              <li>
                <strong>响应式设计</strong>：移动端和桌面端不同的样式和交互
              </li>
              <li>
                <strong>平滑过渡</strong>：使用 cubic-bezier 缓动函数提供流畅的动画效果
              </li>
              <li>
                <strong>主题适配</strong>：完美适配暗色和亮色主题
              </li>
              <li>
                <strong>触摸优化</strong>：移动端触摸友好的设计
              </li>
              <li>
