...
import shareBgTop from 'assets/task/share-bg-top.svg'
import shareBgBottom from 'assets/task/share-bg-bottom.svg'
import mobileShareBgTop from 'assets/task/mobile-share-bg-top.svg'
import mobileShareBgBottom from 'assets/task/mobile-share-bg-bottom.svg'
...
export function useCopyImgAndText() {
  ...
  const copyImgAndText = useCallback(
    async ({
      ...
      const text = new Blob([`${shareUrl}\nTrade smarter with Holominds real-time AI insights.`], {
        type: 'text/plain',
      })
