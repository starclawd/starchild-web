      ...
      <DemoSection>
        ...
        <PresetPanel>
          {presets.map((preset, index) => (
            <PresetButton
              key={index}
              onClick={() => setCustomMarkdown(preset.content)}
            >
              {preset.name}
            </PresetButton>
          ))}
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              <li><strong>标准语法</strong>：支持完整的 Markdown 标准语法</li>
              <li><strong>链接安全</strong>：外部链接自动添加安全属性，新标签页打开</li>
              <li><strong>代码高亮</strong>：支持多种编程语言的代码块</li>
              <li><strong>主题适配</strong>：完美适配暗色和亮色主题</li>
              <li><strong>移动优化</strong>：响应式设计，移动端友好</li>
              <li><strong>自定义滚动条</strong>：代码块提供优雅的滚动体验</li>
              <li><strong>样式重置</strong>：恢复列表等元素的原生样式</li>
              <li><strong>灵活布局</strong>：宽度自适应，可嵌套在任意容器中</li>
            </ul>
          </div>
        </div>
