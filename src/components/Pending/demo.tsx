  ...
  return (
    <DemoContainer>
      <DemoSection>
        ...
        <p>
          Pending 组件用于显示加载状态，具有旋转动画效果。
          支持小型和大型两种显示模式，自动适配移动端和桌面端样式。
        </p>
      </DemoSection>
          ...
          <div className="mock-content">
            {mockData.map(item => (
              <div key={item.id} style={{ 
                ...
                <span>{item.name}</span>
                <span style={{ color: item.status === '已完成' ? '#52c41a' : '#faad14' }}>
                  {item.status}
                </span>
              </div>
            ))}
      ...
      <DemoSection>
        ...
        <div style={{ padding: '20px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '15px' }}>
            ...
            <ControlButton 
              onClick={startProgressSimulation}
  ...
  <div>
    ...
    <div className="progress-bar">
      ...
      <DemoSection>
        ...
        <ControlPanel>
          <ControlButton onClick={() => startLoading(1)}>
            2秒加载测试
          </ControlButton>
          <ControlButton onClick={() => startLoading(2)}>
            3秒加载测试
          </ControlButton>
          <ControlButton onClick={() => startLoading(3)}>
            1.5秒加载测试
          </ControlButton>
        </ControlPanel>
      </DemoSection>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              <li><strong>旋转动画</strong>：使用 CSS 动画实现平滑的旋转效果</li>
              <li><strong>双模式设计</strong>：普通模式和全屏模式，适应不同使用场景</li>
              <li><strong>响应式设计</strong>：移动端和桌面端不同的字体大小</li>
              <li><strong>灵活定制</strong>：支持自定义图标样式和文字内容</li>
              <li><strong>主题适配</strong>：使用主题色彩，完美适配暗色和亮色主题</li>
              <li><strong>轻量级</strong>：组件体积小，性能优秀</li>
              <li><strong>易用性</strong>：简单的 API，开箱即用</li>
              <li><strong>国际化支持</strong>：配合 @lingui 实现多语言支持</li>
            </ul>
          </div>
        </div>
