    ...
    <DemoContainer>
      ...
      <DemoSection>
        ...
        <DemoRow>
          ...
          <div className='demo-area'>
            <ControlsArea>
              <ControlButton $active={heightVisible} onClick={() => setHeightVisible(!heightVisible)}>
              ...
              >
                <ContentBox>
                  ...
                  <div className='content'>
                    这是一个演示高度过渡动画的内容区域。当点击展开按钮时， 内容会以平滑的动画效果从0高度展开到完整高度。
                  </div>
                  <div className='content'>
                    TransitionWrapper 会自动计算内容的实际高度， 并创建流畅的过渡动画效果。这对于创建手风琴组件、
                    展开式菜单等交互效果非常有用。
                  </div>
                  <div className='info'>过渡类型: height | 自动高度计算</div>
                </ContentBox>
              </TransitionWrapper>
            </TransitionArea>
          </div>
      ...
      <DemoSection>
        ...
        <DemoRow>
          ...
          <div className='demo-area'>
            <ControlsArea>
              <ControlButton $active={widthVisible} onClick={() => setWidthVisible(!widthVisible)}>
            ...
            <TransitionArea style={{ display: 'flex', alignItems: 'flex-start' }}>
              ...
              >
                <ContentBox style={{ minWidth: '280px', margin: '10px' }}>
                  ...
                  <div className='content'>这是一个侧边面板的演示，展示了宽度过渡动画的效果。</div>
                  <div className='content'>面板会从0宽度平滑展开到设定的宽度， 适合用于侧边栏、工具面板等场景。</div>
                  <div className='info'>过渡类型: width | 默认宽度: 300px</div>
                </ContentBox>
              </TransitionWrapper>
      ...
      <DemoSection>
        ...
        <DemoRow>
          ...
          <div className='demo-area'>
            <ControlsArea>
              <ControlButton $active={transformVisible} onClick={() => setTransformVisible(!transformVisible)}>
            ...
            <TransformContainer>
              ...
              >
                ...
                >
                  ...
                  <div className='content'>
                    当前从 {transformDirection} 方向滑入。 这种动画效果常用于移动端的页面切换、 模态框的进入退出等场景。
                  </div>
                  <div className='info'>过渡类型: transform | 方向: {transformDirection}</div>
                </ContentBox>
              </TransitionWrapper>
            </TransformContainer>
          </div>
      ...
      <DemoSection>
        ...
        <DemoRow>
          ...
          <div className='demo-area'>
            <ControlsArea>
              <ControlButton $active={complexVisible} onClick={() => setComplexVisible(!complexVisible)}>
                {complexVisible ? '隐藏' : '显示'}
              </ControlButton>

              <div style={{ display: 'flex', gap: '8px', marginLeft: '20px' }}>
                {(['height', 'width', 'transform'] as const).map((type) => (
                  <ControlButton key={type} $active={complexType === type} onClick={() => setComplexType(type)}>
                    {type}
                  </ControlButton>
                ))}
              </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className='info'>当前过渡类型: {complexType}</div>
                </ContentBox>
              </TransitionWrapper>
            </TransitionArea>
          </div>
      ...
      <div style={{ marginTop: '40px' }}>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              <li>
                <strong>height</strong>：垂直方向的高度过渡，自动计算内容高度
              </li>
              <li>
                <strong>width</strong>：水平方向的宽度过渡，可设置默认宽度
              </li>
              <li>
                <strong>transform</strong>：基于位移和透明度的过渡，支持四个方向
              </li>
            </ul>
          </div>
        </div>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              <li>
                <strong>手风琴组件</strong>：使用 height 类型实现内容展开收起
              </li>
              <li>
                <strong>侧边栏</strong>：使用 width 类型实现面板滑入滑出
              </li>
              <li>
                <strong>页面切换</strong>：使用 transform 类型实现页面间的过渡
              </li>
              <li>
                <strong>模态框</strong>：使用 transform 类型实现弹出动画
              </li>
              <li>
                <strong>下拉菜单</strong>：使用 height 类型实现菜单展开
              </li>
            </ul>
          </div>
        </div>
