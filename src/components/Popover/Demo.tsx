...
const PopoverDemo = () => {
  ...
  const BasicPopoverContent = () => (
    <PopoverContent>
      ...
      <div className='popover-text'>这是一个基础的弹出框示例，可以包含任意内容。</div>
  ...
  const PositionPopoverContent = ({ title }: { title: string }) => (
    <PopoverContent>
      ...
      <div className='popover-text'>这个弹出框从{title}方向显示，展示了不同的定位效果。</div>
    </PopoverContent>
  )
  ...
  const ActionPopoverContent = () => (
    <PopoverContent>
      ...
      <div className='popover-text'>您确定要执行此操作吗？此操作无法撤销。</div>
      <div className='popover-actions'>
        <button
          className='popover-button secondary'
          onClick={() => {
  ...
  const CustomPopoverContent = () => (
    ...
    >
      ...
      <div style={{ fontSize: '12px', opacity: 0.9 }}>这是一个自定义样式的弹出框</div>
      <button
        style={{
          marginTop: '10px',
          padding: '6px 12px',
  ...
  return (
    <DemoContainer>
      <DemoSection>
        ...
        <p>
          Popover 组件基于 @popperjs/core 实现，提供灵活的弹出提示功能。 支持多种定位方式、自定义样式和丰富的交互选项。
        </p>
      </DemoSection>
      ...
      <DemoSection>
        ...
        <DemoRow>
          <div className='demo-area'>
            ...
            >
              <TriggerButton onClick={handleBasicToggle}>{showBasic ? '关闭弹出框' : '点击显示弹出框'}</TriggerButton>
            </Popover>
          </div>
      ...
      <DemoSection>
        ...
        <PopoverGrid>
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <Popover show={showTop} content={<PositionPopoverContent title='顶部' />} placement='top'>
              <TriggerButton onClick={() => handlePositionShow('顶部弹出框', setShowTop)}>顶部弹出</TriggerButton>
            </Popover>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <Popover show={showLeft} content={<PositionPopoverContent title='左侧' />} placement='left'>
              <TriggerButton onClick={() => handlePositionShow('左侧弹出框', setShowLeft)}>左侧弹出</TriggerButton>
            </Popover>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <Popover show={showRight} content={<PositionPopoverContent title='右侧' />} placement='right'>
              <TriggerButton onClick={() => handlePositionShow('右侧弹出框', setShowRight)}>右侧弹出</TriggerButton>
            </Popover>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <Popover show={showBottom} content={<PositionPopoverContent title='底部' />} placement='bottom'>
              <TriggerButton onClick={() => handlePositionShow('底部弹出框', setShowBottom)}>底部弹出</TriggerButton>
            </Popover>
          </div>
        </PopoverGrid>
      ...
      <DemoSection>
        ...
        <DemoRow>
          <div className='demo-area'>
            <Popover
              ...
              content={
                <PopoverContent>
                  ...
                  <div className='popover-text'>鼠标悬停时显示的提示信息，移开鼠标时自动隐藏。</div>
                </PopoverContent>
              }
              placement='top'
              onMouseEnter={() => {
            ...
            >
              <SecondaryButton>悬停显示提示</SecondaryButton>
            </Popover>
          </div>
          <div className='demo-info'>
            <div>
        ...
        >
          <div style={{ textAlign: 'center' }}>
            ...
            <Popover
              show={showTop}
              content={
                <div style={{ padding: '10px', background: 'white', borderRadius: '4px', color: 'black' }}>
                  默认偏移
                </div>
              }
              placement='top'
            >
              <SecondaryButton onClick={() => handlePositionShow('默认位置', setShowTop)}>默认位置</SecondaryButton>
            </Popover>
          </div>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <Popover
              ...
              offsetTop={10}
            >
              <SecondaryButton onClick={() => handlePositionShow('向上偏移', setShowBottom)}>向上偏移</SecondaryButton>
            </Popover>
          </div>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <Popover
              ...
              offsetLeft={-15}
            >
              <SecondaryButton onClick={() => handlePositionShow('向左偏移', setShowLeft)}>向左偏移</SecondaryButton>
            </Popover>
          </div>
        </div>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              <li>
                <strong>智能定位</strong>：基于 @popperjs/core 的智能定位算法
              </li>
              <li>
                <strong>防溢出</strong>：自动避免弹出框超出视窗边界
              </li>
              <li>
                <strong>动画效果</strong>：丰富的进入和退出动画效果
              </li>
              <li>
                <strong>Portal 渲染</strong>：使用 Portal 组件避免层级问题
              </li>
              <li>
                <strong>点击外部关闭</strong>：支持点击外部区域自动关闭
              </li>
              <li>
                <strong>多种触发方式</strong>：支持点击和悬停触发
              </li>
              <li>
                <strong>响应式适配</strong>：自动适应不同屏幕尺寸
              </li>
              <li>
                <strong>高度可定制</strong>：支持自定义样式和偏移量
              </li>
            </ul>
          </div>
        </div>
