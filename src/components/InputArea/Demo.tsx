...
/>`}
      ...
      <DemoSection>
        ...
        <ControlPanel>
          <SecondaryButton onClick={addLongText}>
            添加长文本测试
          </SecondaryButton>
          <DangerButton onClick={() => setLimitedValue('')}>
            清空内容
          </DangerButton>
        </ControlPanel>
...
// 字符数限制会阻止超长输入和粘贴`}
      ...
      <DemoSection>
        ...
        <ControlPanel>
          <ControlButton onClick={fillSampleText}>
            填充示例文本
          </ControlButton>
          <SecondaryButton onClick={() => setAutoHeightValue('')}>
            清空内容
          </SecondaryButton>
        </ControlPanel>
      ...
      <DemoSection>
        ...
        <DemoRow>
          <div className="textarea-container">
            ...
            />
            <LimitIndicator 
              isNearLimit={pasteValue.length > 40} 
              isOverLimit={pasteValue.length >= 50}
            >
      ...
      <DemoSection>
        ...
        <StatusDisplay>
          ...
          <div className="status-item">
            ...
            <span className="value">获得 {focusCount} / 失去 {blurCount}</span>
          </div>
          <div className="status-item">
        ...
        <ControlPanel>
          <DangerButton onClick={clearAllContent}>
            清空所有内容
          </DangerButton>
          <ControlButton onClick={fillSampleText}>
            填充示例内容
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              <li><strong>自动高度调整</strong>：根据内容动态调整高度，最大240px</li>
              <li><strong>字符数限制</strong>：支持输入和粘贴的字符数限制</li>
              <li><strong>Enter 键处理</strong>：桌面端 Enter 确认，Shift+Enter 换行</li>
              <li><strong>移动端优化</strong>：移动端 Enter 键正常换行，无确认功能</li>
              <li><strong>粘贴验证</strong>：自动验证粘贴内容长度，超限时阻止</li>
              <li><strong>响应式设计</strong>：窗口大小变化时自动调整</li>
              <li><strong>滚动条样式</strong>：内容超出时显示自定义样式滚动条</li>
