    ...
    <DemoContainer>
      ...
      <DemoSection>
        ...
        <ControlsArea>
          ...
          <ControlButton 
            $active={disabledPull}
            onClick={() => setDisabledPull(!disabledPull)}
          >
      ...
      <DemoSection>
        <h3>交互演示</h3>
        <p>
          📱 在移动设备上：滚动到列表底部，然后继续向上拖拽触发加载<br/>
      ...
      <DemoSection>
        ...
        <div style={{ 
          ...
          <ul style={{ 
            ...
            <li><strong>智能触发</strong>：只有滚动到底部时才响应上拉手势</li>
            <li><strong>阻尼效果</strong>：提供自然的拖拽手感和视觉反馈</li>
            <li><strong>状态提示</strong>：显示"加载中"和"上拉加载更多"状态</li>
            <li><strong>可禁用</strong>：支持动态禁用上拉加载功能</li>
            <li><strong>无限滚动</strong>：实现流畅的无限列表加载体验</li>
            <li><strong>滚动兼容</strong>：与现有滚动容器完美兼容</li>
          </ul>
        </div>
      </DemoSection>
