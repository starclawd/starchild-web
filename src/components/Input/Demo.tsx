...
/>`}
      ...
      <DemoSection>
        ...
        <ControlPanel>
          <ControlButton onClick={handleErrorTest}>
            触发错误状态
          </ControlButton>
          <ControlButton onClick={handleClearError}>
            清除错误状态
          </ControlButton>
        </ControlPanel>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              <li><strong>移动端优化</strong>：支持不同的 inputMode，优化移动端键盘体验</li>
              <li><strong>搜索功能</strong>：SEARCH 类型提供搜索图标和清除按钮</li>
              <li><strong>错误处理</strong>：showError 状态下自动聚焦，便于用户修正</li>
              <li><strong>自动聚焦</strong>：支持页面加载时自动聚焦到输入框</li>
              <li><strong>滚动视图</strong>：移动端聚焦时可选择滚动到视图中心</li>
              <li><strong>主题适配</strong>：自动适配暗色和亮色主题</li>
              <li><strong>完整事件</strong>：支持 focus、blur、change、keyup 等完整事件</li>
              <li><strong>灵活定制</strong>：支持自定义样式和类名</li>
            </ul>
          </div>
        </div>
      </div>
