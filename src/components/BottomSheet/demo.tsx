  ...
  <div style={{ padding: '20px' }}>
    ...
    <p>这里是弹层的内容区域</p>
      ...
      <DemoSection>
        ...
        <DemoRow>
          <Button onClick={() => setNoDragSheetOpen(true)}>
            无拖拽句柄弹层
          </Button>
          <div className="demo-info">
  ...
  <div style={{ padding: '20px' }}>
    <p>相对于按钮位置显示的弹层</p>
      ...
      <DemoSection>
        ...
        <DemoRow>
          <Button onClick={() => setCustomContentOpen(true)}>
            自定义内容弹层
          </Button>
          <div className="demo-info">
...
{`interface BottomSheetProps {
  ...
  hideDragHandle?: boolean;                 // 可选：是否隐藏拖拽句柄
      ...
      {/* 实际的弹层组件 */}
      <BottomSheet 
        isOpen={basicSheetOpen}
        onClose={() => setBasicSheetOpen(false)}
      >
        <SheetContent>
          <h4>基本弹层</h4>
          <p>这是一个基本的底部弹层示例。</p>
          ...
          <div className="action-buttons">
            <SheetButton onClick={() => setBasicSheetOpen(false)}>
              关闭
            </SheetButton>
          </div>
        </SheetContent>
      ...
      <BottomSheet 
        isOpen={noDragSheetOpen}
        onClose={() => setNoDragSheetOpen(false)}
        hideDragHandle={true}
      >
        <SheetContent>
          <h4>无拖拽句柄弹层</h4>
          ...
          <div className="action-buttons">
            <SheetButton onClick={() => setNoDragSheetOpen(false)}>
              关闭
            </SheetButton>
          </div>
        </SheetContent>
      ...
      >
        <SheetContent>
          ...
          <div className="action-buttons">
            <SheetButton onClick={() => setPositionSheetOpen(false)}>
              关闭
            </SheetButton>
          </div>
        </SheetContent>
      ...
      >
        <SheetContent>
          ...
          <p>请仔细确认后再进行操作。</p>
          <div className="action-buttons">
            <SheetButton onClick={() => setCustomContentOpen(false)}>
              取消
            </SheetButton>
            <SheetPrimaryButton onClick={() => {
              alert('操作已确认')
