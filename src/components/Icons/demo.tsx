...
const getStaticIconNames = (): string[] => {
  return [
    'approve', 'chart-tool', 'chat-agent-planing', 'chat-analyze-agent',
    'chat-arrow-long', 'chat-arrow-short', 'chat-back', 'chat-border-close',
    'chat-close', 'chat-complete', 'chat-copy', 'chat-default-ui',
    'chat-delete', 'chat-dislike-fill', 'chat-dislike', 'chat-expand-down',
    'chat-expand', 'chat-file', 'chat-hammer', 'chat-history',
    'chat-like-fill', 'chat-like', 'chat-more', 'chat-new',
    'chat-noti-disable', 'chat-noti-enable', 'chat-other', 'chat-process',
    'chat-refresh', 'chat-robot', 'chat-rubbish', 'chat-send',
    'chat-share', 'chat-shortcuts', 'chat-star-empty', 'chat-star',
    'chat-stop-play', 'chat-stop-voice', 'chat-switch', 'chat-tell-more',
    'chat-thinking', 'chat-unselected', 'chat-upload', 'chat-useless',
    'chat-voice', 'check', 'coinmarketcap', 'disconnect',
    'discord', 'download', 'exit-fullscreen', 'eye',
    'fullscreen', 'github', 'header-mobile', 'header-noti',
    'header-pc', 'header-qrcode', 'header-setting', 'language',
    'liquidity', 'loading', 'play', 'receive',
    'required', 'scan', 'search', 'selected',
    'send', 'stake', 'style-type', 'task-detail-his',
    'task-detail', 'task-list', 'tooltip-arrow', 'twitter',
    'unselected', 'warn', 'watch-list'
  ]
}
