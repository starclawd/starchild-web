  ...
  return (
    <DemoContainer>
      ...
      <DemoSection>
        ...
        {showBodyPortal && (
          <Portal>
            <PortalContent title='Body Portal' onClose={() => setShowBodyPortal(false)} />
          </Portal>
        )}
      </DemoSection>
          ...
          >
            ...
            {showCustomPortal && customContainer && (
              <Portal rootEl={customContainer}>
                ...
                >
                  <div style={{ marginBottom: '10px', fontWeight: 'bold' }}>Portal 内容</div>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '8px' }}>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
              <li>
                <strong>弹窗和对话框</strong>：避免 z-index 层级问题
              </li>
              <li>
                <strong>提示和通知</strong>：在页面顶层显示消息
              </li>
              <li>
                <strong>下拉菜单</strong>：避免父容器 overflow 限制
              </li>
              <li>
                <strong>工具提示</strong>：确保提示框不被遮挡
              </li>
              <li>
                <strong>全屏组件</strong>：如图片预览、视频播放器
              </li>
            </ul>
          </div>
        </div>
