...
import { TgLogin } from 'pages/components/Header/components/TgLogin'
...
import Preference from 'pages/components/Header/components/Preference'
import { useGetPreference } from 'store/perference/hooks'
import { AccountManegeModal } from 'pages/components/Header/components/AccountManege'
import { EditNicknameModal } from 'pages/components/Header/components/AccountManege/components/EditNicknameModal'
import AvatarEditModal from 'pages/components/Header/components/AccountManege/components/AvatarEditModal'
...
import SwitchChainModal from 'pages/components/SwitchChainModal'
