...
export default function TransactionDetail({
  ...
  const txInfo = useMemo(() => {
    ...
    if (originalResult.receipt_status === '0') {
      ...
      if (
        (!originalResult.erc20_transfers || originalResult.erc20_transfers.length === 0) &&
  ...
  const dataList = useMemo(() => {
      ...
      },
      {
        ...
        list: [
          ...
          },
          {
            ...
            value: <TimeWrapper>{formatTimestamp(originalResult.block_timestamp)}</TimeWrapper>,
          },
        ],
      },
    ]
    ...
    goHashPage,
    theme,
    originalResult.block_hash,
    originalResult.block_timestamp,
    originalResult.transaction_fee,
    originalResult.from_address,
    originalResult.to_address,
  ])
