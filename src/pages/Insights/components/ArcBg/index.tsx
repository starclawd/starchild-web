  ...
  return (
    <ArcBgWrapper>
      {isLong ? (
        <>
          <ArcFill>
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 399 157" fill="none" preserveAspectRatio={"none"}>
          ...
          <ArcLine>
            <svg ref={lineRef} xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 399 142" fill="none" preserveAspectRatio={"none"}>
        ...
        <>
          <ArcFill>
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 400 157" fill="none" preserveAspectRatio={"none"}>
