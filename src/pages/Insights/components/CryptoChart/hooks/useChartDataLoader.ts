...
export const useChartDataLoader = ({
      ...
      const handleVisibleRangeChange = () => {
        ...
        if (isScrollingLeft && logicalRange.from < 10) {
          ...
          triggerGetKlineData({
            ...
            isBinanceSupport
          } as KlineDataParams).then((response: any) => {
  ...
  }, [chartData, paramSymbol, selectedPeriod, reachedDataLimit, binanceTimeZone, isBinanceSupport, triggerGetKlineData, getConvertPeriod, chartRef, seriesRef, setChartData, setReachedDataLimit]);
};