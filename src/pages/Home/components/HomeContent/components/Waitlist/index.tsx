...
export default function Waitlist() {
  ...
  return (
    <WaitlistWrapper>
      ...
      <Text>
        <span>
          <Trans>You are not on our waitlist</Trans>
        </span>
        <span>
          <Trans>
            Please leave your telegram account and email address, and follow our telegram bot @xxxxxxx. You will be
            notified once ready.
          </Trans>
        </span>
        <InputContent>
          <InputerWrapper className=''>
            <input readOnly type='text' value={`@${telegramUserName}`} placeholder='Your telegram ID' />
          </InputerWrapper>
