...
export default function MobileBackTest() {
  ...
  return (
    <MobileBackTestWrapper key={orientationKey} ref={backTestWrapperRef as any}>
      {isLoading ? (
        <Pending isFetching />
      ) : (
        <>
          ...
          />
          <Highlights key={`highlights-${orientationKey}`} isMobileBackTestPage={true} backtestData={backtestData} />
        </>
      )}
