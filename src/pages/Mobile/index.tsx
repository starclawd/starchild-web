...
import { MobileBackTest, MobileBackTestDetail, MobileDownload, MobileInsights, MobileTradeAi, ROUTER } from 'pages/router'
  ...
  return (
    <MobileWrapper>
      <Routes>
        ...
        <Route path={ROUTER.BACK_TEST_DETAIL} element={<MobileBackTestDetail />} />
