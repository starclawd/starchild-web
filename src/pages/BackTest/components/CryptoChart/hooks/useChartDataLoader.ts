...
export const useChartDataLoader = ({
  ...
  }, [chartData, paramSymbol, selectedPeriod, reachedDataLimit, binanceTimeZone, isBinanceSupport, getMarksTimeRange, triggerGetKlineData, getConvertPeriod, refreshTradeMarkers, seriesRef, chartRef, setChartData, setReachedDataLimit]);
