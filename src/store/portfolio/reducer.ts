...
export const portfolioSlice = createSlice({
  ...
  reducers: {
    ...
    updateAllNetworkWalletToken: (
      state,
      action: PayloadAction<(AllEvmWalletTokensDataType | AllSolanaWalletTokensDataType)[]>,
    ) => {
...
export const { updateCurrentWalletAddress, updateWalletHistory, updateNetWorthList, updateAllNetworkWalletToken } =
